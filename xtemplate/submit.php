        ...
        <div class="wrapper">
            <header class="page-header">
                ...
                <div class="head1" id="clash_name">
                    <b>CodeWars - Giao lưu lập trình 2022</b>
                </div>
            ...
            <main class="page-main">
                <div class="problem">
                    ...
                    <h3>Submission</h3>
                    <p id="submission-working">Bạn chưa Submit!</p>
                    <div class="test-case">
                    ...
                    <h3>Problem</h3>
                    <p>Tìm số lớn nhất trong 3 số được nhập từ bàn phím.</p>
                </div>
                <div class="submission">
<!--                     <div class="code_editor">
                        
                        <select id="lang" onchange="changeMode(this)" class="lang_selector">
                            <option disabled selected id="title_lang_selector">Đang tải dữ liệu...</option>
                        </select>
                    ...
                    <div class="code_editor">
                        <textarea id="code" placeholder="Đang tải Code Editor..."></textarea>
                    </div>
                    <div class="submit_select">
                        <div class="editor_config__select_language">
                            <select id="lang" onchange="changeMode(this)" class="lang_selector" title="Đổi ngôn ngữ">
                                <option disabled selected id="title_lang_selector">Đang tải dữ liệu...</option>
                            </select>
                            <span class="focus"></span>
                        </div>
                        <div class="editor_config__select_theme">
                            <select id="theme" onchange="changeTheme(this)" class="theme_selector" title="Đổi giao diện">
                                <option disabled selected id="title_theme_selector">Đang tải dữ liệu...</option>
                            </select>
                        </div>
<!--                    <select id="lang" onchange="changeMode(this)" class="lang_selector">
                            <option disabled selected id="title_lang_selector">Đang tải dữ liệu...</option>
